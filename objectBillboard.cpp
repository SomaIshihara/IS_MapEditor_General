...
//生成処理
//========================
CObjectBillboard* CObjectBillboard::Create(const D3DXVECTOR3 pos, const float fWidth, const float fHeight, const int nIdxTexture)
{
	...
	if (pObjBillboard == nullptr)
	{
		...
		pObjBillboard->SetSize(fWidth, fHeight);
